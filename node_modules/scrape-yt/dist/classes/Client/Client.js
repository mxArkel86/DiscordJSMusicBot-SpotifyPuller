...
var YoutubeClient = /** @class */ (function () {
                    ...
                    case 1:
                        ...
                        for (_i = 0, contents_1 = contents; _i < contents_1.length; _i++) {
                            ...
                            if ("playlistRenderer" in content)
                                results.push(new __1.PlaylistCompact().load(content.playlistRenderer));
                            else if ("videoRenderer" in content)
                                results.push(new __1.VideoCompact().load(content.videoRenderer));
                            else if ("channelRenderer" in content)
                                results.push(new __1.Channel().load(content.channelRenderer));
     ...
     */
    YoutubeClient.prototype.getPlaylist = function (playlistIdOrUrl, options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        options = __assign({ continuationLimit: 0 }, options);
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, new __1.Playlist().load(response.data, options.continuationLimit)];
                }
            });
        });
    };
     ...
     */
    YoutubeClient.getSearchTypeParam = function (type) {
        var searchType = {
            video: "EgIQAQ%3D%3D",
